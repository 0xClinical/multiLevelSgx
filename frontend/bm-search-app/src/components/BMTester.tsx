...
import { bmServices } from '../services/api';
import { 
  generateTestUser, 
...
const BMTester: React.FC = () => {
  ...
  const handleAddUser = async () => {
    ...
    try {
      ...
      const response = await bmServices.addUser(user);
      setCurrentUser(user);
  ...
  const handleUploadDocument = async () => {
    ...
    try {
      ...
      const response = await bmServices.uploadDocument(keyword, document);
  ...
  const handleUploadMultipleDocuments = async () => {
    ...
    try {
      ...
      const response = await bmServices.uploadDocuments(keyword, documents);
  ...
  const handleDeleteDocument = async () => {
    ...
    try {
      ...
      const response = await bmServices.deleteDocument(currentKeyword, documentToDelete.id);
  ...
  const handleSearch = async () => {
    ...
    setLoading(true);
    try {
      const response = await bmServices.search(
        currentUser.id, 
  ...
  const handleRebuildIndices = async () => {
    setLoading(true);
    try {
      const response = await bmServices.rebuildIndices();
